...
#define depmod_trivial_usage "[-n] [MODFILES]..." \
...
#if ENABLE_MODPROBE_SMALL || ENABLE_FEATURE_MODPROBE_SMALL_OPTIONS_ON_CMDLINE \
...
#define losetup_trivial_usage \
       "[-r] [-o OFS] LOOPDEV FILE - associate loop devices\n" \
...
#define udhcpc6_trivial_usage \
       "[-fbnq"IF_UDHCP_VERBOSE("v")"oR] [-i IFACE] [-r IP] [-s PROG] [-p PIDFILE]\n" \
...
#define udhcpc_trivial_usage \
       ...
       "	[-V VENDOR] [-x OPT:VAL]... [-O OPT]..." IF_FEATURE_UDHCP_PORT(" [-P N]") \
